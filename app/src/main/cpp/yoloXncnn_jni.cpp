...
Java_com_jiwon_android_1ncnn_1ml_ml_YOLOX_init(JNIEnv* env, jobject thiz, jobject assetManager)
{
    ncnn::Option opt;
    opt.lightmode = true;
    opt.num_threads = 4;
    ...
    // init jni glue
    jclass localObjCls = env->FindClass("com/jiwon/android_ncnn_ml/ml/YOLOX$Object");
    objCls = reinterpret_cast<jclass>(env->NewGlobalRef(localObjCls));

    constructortorId = env->GetMethodID(objCls, "<init>", "(FFFFLjava/lang/String;F)V");
...
Java_com_jiwon_android_1ncnn_1ml_ml_YOLOX_detect(JNIEnv* env, jobject thiz, jobject bitmap, jboolean use_gpu)
{
    ...
    {
        jobject jObj = env->NewObject(objCls, constructortorId, objects[i].x, objects[i].y, objects[i].w, objects[i].h, env->NewStringUTF(class_names[objects[i].label]), objects[i].prob);
